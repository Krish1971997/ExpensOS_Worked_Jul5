...
public class AiCandidate {
    ...
    public static String providerLabel(String p) {
        if (p == null) return "AI";
        switch (p) {
            case AppConfig.PROVIDER_OPENAI: return "OpenAI";
            case AppConfig.PROVIDER_GROK: return "Grok";
            case AppConfig.PROVIDER_CLAUDE: return "Claude";
            case AppConfig.PROVIDER_GENSPARK: return "Genspark";
