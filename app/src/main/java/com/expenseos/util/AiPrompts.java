...
public final class AiPrompts {
    ...
    public static String systemPrompt() {
        ...
        return "You are the in-app data assistant for ExpenseOS, a personal expense-tracking app. "
                ...
                + "CHARTS: render_chart supports chart_type='bar' (default) or 'pie'; call it AFTER querying data; "
                + "for BOTH day-wise AND category-wise in one turn call render_chart TWICE (\"Day-wise\", then \"Category-wise\") — both show under one bubble. "
